...
Este projeto recria o fluxo ETL (Extract, Transform, Load) apresentado no desafio original da Santander Dev Week 2023, mas com uma adaptação fundamental: como não temos acesso à API original do Santander, utilizamos o Google Sheets como fonte e destino dos dados.
...
| OpenAI (gpt-4-mini) | Geração das mensagens    | 
